...
function MyPage(props) {
    ...
    useEffect(() => {
        const fetchUserData = async () => {
            ...
            try {
                const response = await axios.get("http://3.38.169.158/account/userinfo/", {
                    headers: {
    ...
    const handleUpdate = async (e) => {
        ...
        try {
            ...
            const response = await axios.post("http://3.38.169.158/account/userinfo/", data, {
                headers: {
                    "Content-Type": "application/json",
                    "Authorization": `Bearer ${accessToken}`,
                },
            ...
            // 기존 records 데이터 유지하며 userData 업데이트
            setUserData((prevData) => ({
                ...response.data,
                records: prevData.records, // 기존 records 데이터 유지
            }));
                                ...
                                {userData.records
                                    ...
                                    .map((record) => (
                                        <RecordItem key={record.id}>
                                            ...
                                            <RecordInfo>
                                                <RecordLabel>🗓️ 운동 날짜</RecordLabel>
